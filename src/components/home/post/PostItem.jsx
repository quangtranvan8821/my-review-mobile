...
const PostUser = {
  user: "vietdeptrai",
  image:
    "https://ben.com.vn/tin-tuc/wp-content/uploads/2021/12/anh-che-meo-dang-yeu-cho-may-tinh-6.jpg",
  content:
  ...
  const onShare = async () => {
    try {
      await Share.share({
        title: "hihi",
        message:
          "https://www.facebook.com/groups/869629100893457/permalink/928722028317497/",
